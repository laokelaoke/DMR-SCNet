...
parser.add_argument('--train_data_dir', type=str, default='uimagine1/train/image')
parser.add_argument('--train_label_dir', type=str, default='uimagine1/train/label')
parser.add_argument('--data_augmentation', type=bool, default=True)
parser.add_argument('--eval_data_dir', type=str, default='uimagine1/test/image')
parser.add_argument('--eval_label_dir', type=str, default='uimagine1/test/label')
